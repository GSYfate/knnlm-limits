...
class KNNSaver(object):
    ...
    def build_index(self, num_keys_to_add_at_a_time=1000000, 
        ...
        dstore_dir = "/home/sg2323/datastore/knn-prompt/meta-llama/Meta-Llama-3-8B"
        index_name = get_index_path(dstore_dir, self.model.config.model_type, self.dstore_size, self.dimension) 
